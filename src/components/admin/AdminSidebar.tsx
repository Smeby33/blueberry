...
export function AdminSidebar({
  ...
  return <div className={`flex-1 bg-[#00559b] ${className}`}>
      ...
      <div className="px-2 py-4 mt-auto border-t border-[#2b5a67]">
        <NavLink to="/profile" className="flex items-center w-full px-2 py-2 text-sm font-medium text-gray-100 rounded-md hover:bg-[#7ff4eb] hover:text-white transition-colors mb-2">
