    ...
    <div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4 text-[#00559b]">
          ...
          <div className="text-center mt-8">
            <Link to="/menu" className="inline-block bg-[#00559b] hover:bg-[#2b5a67] text-white font-medium py-3 px-6 rounded-md transition-colors">
